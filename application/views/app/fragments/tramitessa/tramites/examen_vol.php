<div style="position: absolute; padding-top:200px; left:25px; width:700px; z-index:200 !important; font-family: sans-serif !important;">
	<table style="font-size: 14px; width:600px; margin-top: 40px; position:relative; border-collapse: collapse; margin-left: 50px; height: auto;" cellpadding="1" cellspacing="0">
		<tr>
	...
	<table style="font-size: 14px; width:600px; position:relative; border-collapse: collapse; margin-left: 50px; height: auto; margin-top: 50px; text-align: justify;" cellpadding="1" cellspacing="0">
		<tr>
			...
			<?php else: ?><td>Notifico a usted que en la sesión <?=$tipoSesion?> del H. Consejo Académico de la Facultad de Informática, celebrada el día <?=fancy_date($fechaCon)?>, se acordó por unanimidad <?=$decision?> examen voluntario de la materia: <b><?=$materia->nombreMateria?></b> con clave: <b><?=$materia->cveMateria?></b>.</td>
			<?php endif; ?>
		</tr>
	</table>

	<?php if ($decision=="autorizar"): ?>
	<table style=" width:600px; margin-left: 50px; margin-top: 30px; position:relative; border-collapse: collapse; text-align: center;">
	...
	<table style="font-size: 14px; width:600px; position:relative; border-collapse: collapse; margin-left: 50px; height: auto; margin-top: 20px; text-align: justify;" cellpadding="1" cellspacing="0">		
		<tr>
			<td style="padding-top: 10px; padding-bottom: 20px; box-sizing: border-box;">Siendo su presidente <?=$presidente->nombreMaestro?> con clave <?=$presidente->cveMaestro?> y sus sinodales: <?=$sinodalUno->nombreMaestro?> con clave <?=$sinodalUno->cveMaestro?> y <?=$sinodalDos->nombreMaestro?> con clave <?=$sinodalDos->cveMaestro?>.</td>
		</tr>
		<tr>
			<td style="padding-top: 10px; box-sizing: border-box;">Sin más por el momento, y agradeciendo la atención a la presente me despido quedando a sus órdenes para cualquier duda o aclaración al respecto.</td>
		</tr>
	</table>
	<?php endif; ?>
	...
	<table style="font-size: 14px; width:600px; position:relative; border-collapse: collapse; margin-left: 50px; height: auto; margin-top: 20px; text-align: justify;" cellpadding="1" cellspacing="0">		
		<tr>
			<td style="padding-top: 20px; box-sizing: border-box;">Sin otro particular por el momento, hago propicia la ocasión para enviarle un cordial saludo, y quedo a sus órdenes para cualquier comentario al respecto.</td>
		</tr>
	</table>
	<?php endif; ?>
