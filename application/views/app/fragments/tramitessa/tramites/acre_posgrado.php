<div style="position: absolute; padding-top:200px; left:25px; width:700px; z-index:200 !important; font-family: sans-serif !important;">
	...
	<table style="font-size: 14px; width:600px; position:relative; border-collapse: collapse; margin-left: 50px; height: auto; margin-top: 30px; text-align: justify;" cellpadding="1" cellspacing="0">
		...
		<tr>
			<td style="padding-left: 70px; padding-right: 70px; padding-top: 30px; box-sizing: border-box;"><?=$decision?> la opción de titulación por <b>ACREDITACIÓN DE ESTUDIOS DE POSGRADO,</b> de acuerdo al Capítulo VII Titulación y Obtención de Grado, Artículo 95 Numeral III del Reglamento de Estudiantes de la Universidad Autónoma de Querétaro</td>
		</tr>
