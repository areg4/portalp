<div style="position: absolute; padding-top: 200px; left:25px; width:700px; z-index:200 !important; font-family: sans-serif !important;">
	...
	<table style="font-size: 14px; width:600px; position:relative; border-collapse: collapse; margin-left: 50px; height: auto; margin-top: 50px; text-align: justify;" cellpadding="1" cellspacing="0">
		<tr>
			<td>En la relación a su solicitud, comunico a Usted que en sesión <?=$tipoSesion?> del día <?=fancy_date($fechaCon)?> del presente año, el H. Consejo Académico de esta Facultad dictaminó:</td>
		</tr>

		<tr>
			<td style="padding-left: 70px; padding-right: 70px; padding-top: 30px; box-sizing: border-box;"><?=$decision?> la opción de titulación por <b>CURSOS Y DIPLOMADOS DE ACTUALIZACIÓN Y PROFUNDIZACIÓN DISCIPLINARIA</b>, de acuerdo al Capítulo VII Titulación y Obtención de Grado, Artículo 95 numeral V del Reglamento de Estudiantes de la Universidad Autónoma de Querétaro.</td>
		</tr>
	...
	<p style="width:700px;  margin-top: 80px;  text-align:center; font-size:14px; display:block;">
		<b>A T E N T A M E N T E <br> "RAZONAMIENTO Y TECNOLOGÍA PARA INNOVAR Y TRASCENDER"</b>
	</p>
	<table style="font-size: 14px; width: 700px; position:relative; margin:85px auto 0 auto; text-align:center;">
			<tbody>
				<tr>
					<td align="center">
