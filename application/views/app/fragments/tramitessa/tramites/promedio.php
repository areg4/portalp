<div style="position: absolute; padding-top:180px; left:25px; width:700px; z-index:200 !important; font-family: sans-serif !important;">
	<table style="font-size: 14px; width:600px; position:relative; margin-top: 40px; border-collapse: collapse; margin-left: 30px; height: auto;" cellpadding="1" cellspacing="0">
		<tr>
	...
	<table style="font-size: 14px; width:600px; position:relative; border-collapse: collapse; margin-left: 30px; height: auto; margin-top: 50px; text-align: justify;" cellpadding="1" cellspacing="0">
		<tr>
			<td>En relación a su solicitud, comunico a Usted que en sesión ordinaria del día <?=fancy_date($fechaCon)?>, el H. Consejo Académico de esta Facultad dictaminó:</td>
		</tr>
