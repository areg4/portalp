...
<br>
    ...
    <?php if (!is_null($archivos)): ?>
      <?php foreach ($archivos as $archivo): ?>
          <div class="col-xs-12 col-sm-12 col-md-2 archivo centrado_p">
            <p>Documento </p>
            <div class="file <?php if ($tramite->estatus == "RECIBO") {
            echo "alta";
          } if ($tramite->estatus == "RECHAZADO") {
            echo "observaciones";
          } if ($tramite->estatus == "REVISANDO") {
            echo "nproceso";
          } if ($tramite->estatus == "APROBADO") {
            echo "finalizado";
          }?>">
